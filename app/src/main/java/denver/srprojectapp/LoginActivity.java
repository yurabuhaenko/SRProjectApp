...
//import android.R;
    ...
    public class LoginActivity extends NavigationDrawerActivity implements LoaderCallbacks<Cursor> {
        ...
        public void ocClickButtonSignIn(View view) {
            attemptLogin();
        }

        public void ocClickButtonSignUp(View view) {
        ...
        public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
            ...
            protected Boolean doInBackground(Void... params) {
                ...
                String jsonStr = sh.makeServiceCall(UrlHolder.getLoginUrl(), ServiceServerHandler.POST, pairs);
